...
class pcrypt_blowfish 
{
    ...
    function _blowfish_crypt(&$Xl, &$Xr)
    {
        ...
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][1];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][2];
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][3];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][4];
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][5];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][6];
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][7];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][8];
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][9];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][10];
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][11];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][12];
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][13];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][14];
        $Xr ^= $this->_F($Xl) ^ $this->bctx['p'][15];	$Xl ^= $this->_F($Xr) ^ $this->bctx['p'][16];
                
        $Xr  = $Xr ^ $this->bctx['p'][17];
    ...
    function _init($key, $is_array)
    {
        ...
        for ($i = 0; $i < 18; $i++)
        {
            ...
            $data = $key[$j];
            $data = ($data << 8) + $key[($j+1) % $keyl];
            $data = ($data << 8) + $key[($j+2) % $keyl];
            $data = ($data << 8) + $key[($j+3) % $keyl];
    ...
    {	
        ...
        $this->_blowfish_crypt($data1,$data2);
